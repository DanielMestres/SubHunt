...
public class SubHunt extends Activity {
    ...
    // Change to true to display debug info on screen
    ...
    */
    void newGame(){
        // Sets coordinates of sub in grid
    ...
    */
    void draw() {
        ...
        // Fills the screen with a dark grey color
        canvas.drawColor(Color.argb(255, 121, 112, 112));

        // Change the paint color to cyan
        paint.setColor(Color.argb(255, 93, 227, 196));
        ...
        // Change the paint color to magenta
        paint.setColor(Color.argb(255, 200, 57, 213));
